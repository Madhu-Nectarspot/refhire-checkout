...
<div class="step_5 section_title" >
          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" name="pay_total1" id="pay_total1" value="" hidden> 
              </div>
            </div>
          </div>
          <div class="row">
        ...
        <input type="text" class="form-control" name="name_on_card" size="20" data-stripe="number" value="" required>
        ...
        <input type="text" class="form-control" name="card_number" size="20" data-stripe="number" value="" required>
        ...
        <label class="control-label" for="expirationMonth">Expiration Date</label>
         <div class="row">
            <div class="col-md-6">
              <select class="form-control col-sm-12" name="expiry_m" data-stripe="exp_month" required>
            ...
            <div class="col-md-6">
              <select class="form-control" data-stripe="exp_year" name="expiry_y">
        ...
        <input type="text" class="form-control" name="cvv" data-stripe="cvc" value="">
