...
<head>
  ...
  <link rel="stylesheet" href="start-v2.css">
      ...
      <div class="step-nav">
                <nav id="navbar-example2" class="navbar navbar-light bg-light">
                  <ul class="nav nav-pills">
                    <li class="nav-item">
                      <a class="nav-link active" href="#step_1">Step
                        <span>1</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#delivery_option">Step
                        <span>4</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="form-wrap">
                  <div class="quote-service-select single-select">
                    <ul>
                      ...
                      <li class="single-slect-list" class="service" value="160" >
              ...
              <div class="step_2 section_title" id="step_2">
                ...
                <div class="form-wrap">
                  <div class="package-select">
                    <ul class="package-ul">
                        <a href="#" data-name="BasickPackage" data-price="10" class="add-to-cart3">
                      <li class="package-list" value="10">
                       ...
                       <a href="#" data-name="PremiumPackage" data-price="20" class="add-to-cart3">
...
<span class='plus-item btn btn-primary input-group-addon add-to-cart' data-name=" NumbersOfPages" data-price="10">+</span>
              ...
              <div class="delivery_option section_title" id="delivery_option">
                <h2>Delivery</h2>
                <div class="delivery-time-select">
                  <!-- <h3>Delivery Time</h3> -->
                  <ul class="delivery-time-ul">
                      <a href="#" data-name="Standard-5b.days" data-price="0" class="add-to-cart2">
                    <li class="delivery-time-list" value="0">
                      ...
                      <p><b>Note:</b> Takes 6-10days</p>
                   
                    </li>
                    </a>
                    <a href="#" data-name="Express-3b.days" data-price="10" class="add-to-cart2">
...
var shoppingCart = (function() {
  ...
  function loadCart() {
    ...
    cart = JSON.parse(sessionStorage.removeItem( 'shoppingCart' ));
     //cart.toggle("shoppingCart");
  }
