          ...
          <div class="col-md-7">
            <div class="tab-content" id="pills-tabContent">
              ...
              <center>
                ...
                <div id="accordion5" class="faq-wrapper">
                  <div class="card">
                    <div class="card-header" id="headingOne">
                      <h5 class="mb-0">
                        <button aria-label="button" class="btn-link" data-toggle="collapse" data-target="#collapseOne"
                          aria-expanded="true" aria-controls="collapseOne">
                          Select Options <span> <i class="fas fa-chevron-down"></i>
                            <i class="fas fa-chevron-up"></i> </span>
                        </button>
                      </h5>
                    </div>

                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion5">
                      <div class="card-body">
                        <p><b>Ads platform</b></p>
                        <ul class="sub-list">
                          <li><label>
                              <span class="txt">Google Ads</span>
                              <input type="radio" class="" name="ads-platform" value="0" checked>
                              <span class="radio-btn"></span>
                              <span class="price">Free</span>
                            </label></li>
                          <li><label>
                              <span class="txt">AdRoll</span>
                              <input type="radio" class="" name="ads-platform" value="40">
                              <span class="radio-btn"></span>
                              <span class="price">+5%</span>
                            </label>
                          </li>
                          <li><label>
                              <span class="txt">Celta</span>
                              <input type="radio" class="" name="ads-platform" value="40">
                              <span class="radio-btn"></span>
                              <span class="price">+5%</span>
                            </label>
                          ...
                          <li><label>
                              <span class="txt">Flashtalking</span>
                              <input type="radio" class="" name="ads-platform" value="40">
                              <span class="radio-btn"></span>
                              <span class="price">+10%</span>
                            </label>
                          ...
                          <li><label>
                              <span class="txt">Display & Video 360 (DoubleClick)</span>
                              <input type="radio" class="" name="ads-platform" value="40">
                              <span class="radio-btn"></span>
                              <span class="price">+20%</span>
                            </label>
                        ...
                        <ul class="sub-list">
                          ...
                          <li>
                            <label>
                              <span class="txt">Cycled animation</span>
                              <input type="checkbox" name="" value="99">
                              <span class="chk-btn"></span>
                              <span class="price">$10</span>
                            </label>
                          ...
                          <li>
                            <label>
                              <span class="txt">Animation reload</span>
                              <input type="checkbox" name="" value="99">
                              <span class="chk-btn"></span>
                              <span class="price">$10</span>
                            </label>
              ...
              <div class="eta-section">
                <div class="total">
                  ...
                  <li>
										...
										<span class="description"><strong>$<span>298</span></strong></span>
									</li>
                  </ul>
                  <button type="submit" class="start-btn">Start Your Project</button>
                </div>
              </div>
            </div>
          </div>
